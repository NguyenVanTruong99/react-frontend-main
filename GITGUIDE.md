...
- Branch out from `develop`  
    ...
    We will periodically merge `develop` into `staging` and into `main`.
...
- Never push into `develop`, `staging`, or `main` branch. Make a Pull Request.
...
- Update your local `develop` branch and do an interactive rebase before pushing your feature and making a Pull Request.
  ...
  > Rebasing will merge in the requested branch (`main` or `develop`) and apply the commits that you have made locally to the top of the history without creating a merge commit (assuming there were no conflicts). Resulting in a nice and clean history. [read more ...](https://www.atlassian.com/git/tutorials/merging-vs-rebasing)
...
*Note: [GitHub Desktop](https://desktop.github.com/) can be helpful here.*
...
The most important thing is to include the GitHub Issue number in the commit message. This will automatically associate the commit with the GitHub Issue. 

An example of a good commit message:  
>`#530 Replaces useClipboard with navigate for showcase details`
