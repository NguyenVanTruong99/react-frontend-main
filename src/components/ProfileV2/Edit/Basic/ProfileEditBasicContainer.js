...
import ProfileEditBasicView from "./ProfileEditBasicView";
...
const schema = yup.object({
  ...
  bio: yup.string().max(125, "Bio cannot exceed 125 characters"),
  location: yup.string(),
});

const ProfileEditBasicContainer = ({ user, onClose }) => {
...
export default ProfileEditBasicContainer;
